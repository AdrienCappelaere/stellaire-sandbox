...
window.STELLAIRE_PRODUCTS = [
  {
    ...
    features: [
      "Diamètre objectif : 70 mm (capacité lumineuse : 100x l'œil nu)",
      "Focale : 700 mm — rapport F/D : f/10",
      "Grossissement utilisable : 14x à 140x",
      "Monture azimutale légère, manipulation intuitive",
      "Trépied aluminium réglable (70-130 cm), valise de transport incluse",
      "Garantie 2 ans + carte du ciel offerte",
    ],
  ...
  },
  {
    ...
    features: [
      "Diamètre objectif : 200 mm — Newton à miroir parabolique",
      "Focale : 1200 mm — rapport F/D : f/6",
      "Monture Dobson azimutale, pointage intuitif",
      "Oculaires Plossl 25mm (48x) et 9mm (133x) inclus",
      "Démontable en 2 parties pour transport",
      "Idéal ciel profond : galaxies, amas, nébuleuses",
    ],
  ...
  },
  {
    ...
    features: [
      "Diamètre : 90 mm — verres ED apochromatiques",
      "Focale : 900 mm — rapport F/D : f/10",
      "Pas d'aberration chromatique mesurable",
      "Monture équatoriale motorisée fournie (suivi RA)",
      "Compatible photographie astronomique longue pose",
      "Valise de transport rigide, accessoires Vixen",
    ],
  ...
  },
  {
    ...
    features: [
      "Grossissement 10x, objectifs 50mm",
      "Champ de vision : 6,5° (114 m à 1000 m)",
      "Lentilles à traitement multicouches",
      "Étanche, garniture caoutchouc anti-choc",
      "Sangle large + bouchons protection inclus",
      "Compatible adaptateur trépied (filetage 1/4 pouce)",
    ],
  ...
  },
  {
    ...
    features: [
      "Densité neutre : ND-13% (transmission 13%)",
      "Compatible tous oculaires coulant 31.75mm",
      "Verre traité antireflet sur les deux faces",
      "Étui de transport rigide inclus",
      "Idéal lune gibbeuse et pleine",
      "Léger (12g) — pas d'impact sur l'équilibre",
    ],
  ...
  },
  {
    ...
    features: [
      "Point rouge projeté sur vitre traitée",
      "Intensité réglable sur 5 niveaux",
      "Fixation queue d'aronde standard (Vixen)",
      "Alimentation pile bouton CR2032 (10h d'autonomie)",
      "Boîtier aluminium anodisé noir mat",
      "Vis de réglage horizontal + vertical",
    ],
  ...
  },
  {
    ...
    features: [
      "320 pages — édition reliée",
      "Cartes des 88 constellations détaillées",
      "Index Messier (M1-M110) complet",
      "Sélection NGC commentée",
      "Cartes saisonnières (latitudes 40°-50° N)",
  ...
  },
  {
    ...
    features: [
      "Format poche (12x18cm) — 240 pages",
      "Une double page par objet Messier",
      "Croquis à la main pour chaque cible",
      "Conseil d'observation par diamètre d'instrument",
      "Index par constellation et par saison",
  ...
  },
  {
    ...
    features: [
      "Format A4 (21x29,7 cm) — plastique souple",
      "Latitude 45° N (France métropolitaine)",
      "Résistante à l'humidité et au froid",
      "Échelle de magnitude jusqu'à 5",
      "Notice d'utilisation au verso",
      "Idéale pour les enfants et débutants",
    ],
  ...
  },
  {
    ...
    features: [
      "Format : 50 x 70 cm",
      "Papier mat 250g qualité galerie",
      "Tirage HD à partir des archives publiques NASA",
      "Édition limitée numérotée à la main",
      "Livré roulé dans un tube cartonné",
      "Cadre non inclus",
    ],
  ...
  },
  {
    ...
    features: [
      "Céramique blanche, impression bleu nuit",
      "Capacité : 350 ml",
      "88 constellations légendées",
      "Compatible lave-vaisselle et micro-ondes",
      "Hauteur : 9,5 cm — Diamètre : 8,2 cm",
      "Emballé en boîte cadeau cartonnée",
    ],
